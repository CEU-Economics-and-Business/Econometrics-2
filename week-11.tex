...
\title[Fuzzy Regression Discontinuity]{Econometrics 2}
...
Probability of receiving treatment does not change from zero to one at the cutoff but changes discontinuously
...
\item Incentives to participate in some program may change discontinuously at
...
%---------------------------------------------------------------------------------%
 ...
 \frame{ \frametitle{What does Fuzzy RD Estimate?}
\begin{itemize}
...
\end{itemize}
 ...
 %---------------------------------------------------------------------------------%
  ...
  \frame{\frametitle{Democracy, Redistribution, and Political Participation: Evidence From Sweden 1919 --1938 (Econometrica, 2014)}
\begin{itemize}
\item Does the form of Democracy matter?
\begin{itemize}
\item Test direct vs representative democracy
\end{itemize}
...
\begin{itemize}
\item Angrist, Joshua D., and J\"{o}rn-Steffen Pischke. Mostly harmless econometrics: An empiricist's companion. Princeton university press, 2008.
...
\item Cunningham, Scott. "Causal Inference: The Mixtape." 
\end{itemize}
}
 \end{document}
